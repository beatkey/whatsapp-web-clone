...
import {unBlockContact} from "../../stores/Contacts";

export default function UnBlockContact() {
   ...
   function unBlockContactHandle() {
      dispatch(unBlockContact(activeMessage))
      dispatch(closeModal())
   }
