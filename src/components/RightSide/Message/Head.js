...
export default function Head({setRightSide}) {
    ...
    return (
        <div
            ...
            <div onClick={() => setRightSide("contactInfo")} className="cursor-pointer flex items-center text-[#e9edef]">
            ...
            <div className="flex items-center text-[#aebac1] gap-4">
                <div onClick={() => setRightSide("search")} className="cursor-pointer">
