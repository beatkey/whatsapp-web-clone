...
import {deleteActiveReply, sendFile, sendMessage} from "stores/Message";
...
export default function Actions() {
   ...
   const activeReply = useSelector(state => {
      return state.message.activeReply.find(value => value.name === activeMessage)
   })
   ...
   const Blocked = () => {
      return <div className="flex items-center justify-center text-[#8696a0] text-[14px]">Can't send a message to
   ...
   const ReplyMessage = ({name, message}) => {
      return (
         <div className="w-full flex items-center bg-color2 h-[70px] py-1.5 absolute -top-[97%] left-0 z-10">
            ...
            <div onClick={() => dispatch(deleteActiveReply(name))} className="ml-5 mr-5 text-[#8696a0] cursor-pointer">
               <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" className=""
                    fill="currentColor" enableBackground="new 0 0 24 24" xmlSpace="preserve"><path d="M19.6004 17.2L14.3004 11.9L19.6004 6.60005L17.8004 4.80005L12.5004 10.2L7.20039 4.90005L5.40039 6.60005L10.7004 11.9L5.40039 17.2L7.20039 19L12.5004 13.7L17.8004 19L19.6004 17.2Z"></path></svg>
            </div>
         </div>
      )
   }
   ...
   return (contact?.blocked ?
         <Blocked/>
         :
         <div className="bg-color2 relative h-[62px] px-5 pl-2 flex border-l border-[rgba(134,150,160,0.15)]">
            {
               (activeReply && <ReplyMessage {...activeReply} />)
            }
            <div className="flex text-[#8696a0] mr-2">
               ...
               >
                  ...
                  <div
                     ...
                     <div onClick={openSendContactModal}
                          className="group flex items-center rounded-full overflow-hidden mb-3">
                        <div>
