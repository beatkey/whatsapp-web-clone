...
export default function Actions() {
    ...
    return (
        <div className="bg-color2 h-[62px] px-5 pl-2 flex items-center border-l border-[rgba(134,150,160,0.15)]">
            <div className="flex items-center text-[#8696a0] mr-2">
                <div className="p-2">
                ...
                <div className={"cursor-pointer relative transition-all rounded-full p-2 " + (open && "bg-[hsla(0,0%,100%,0.1)]")}
                     onClick={handleClick}
