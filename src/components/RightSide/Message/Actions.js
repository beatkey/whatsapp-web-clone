      ...
      <div className="bg-color2 h-[62px] px-5 pl-2 flex border-l border-[rgba(134,150,160,0.15)]">
         <div className="flex text-[#8696a0] mr-2">
            ...
            >
               ...
               <div className={"absolute top-0 left-1/2 -translate-x-1/2 -translate-y-full " + (open ? "block" : 'hidden')}>
                  <div className="group flex items-center rounded-full overflow-hidden mb-3">
                     <div>
                        <svg viewBox="0 0 53 53" width="53" height="53" className="">
                           ...
                           <g clipPath="url(#contact-SVGID_2_)">
                              ...
                              <path fill="#0EABF4" d="M53 26.5H-1.1c0 14.6 13 27.6 27.6 27.6s27.6-13 27.6-27.6H53z"></path>
                           </g>
                           <g fill="#F5F5F5">
                              <path id="svg-contact"
                     ...
                     <div className="min-w-max opacity-0 group-hover:opacity-100 transition-all absolute left-full ml-3 px-4 py-1 text-[14px] rounded-full text-[#000] bg-[#fff]">
                        Contact
                     </div>
                  </div>
                  <div className="group flex items-center rounded-full overflow-hidden mb-3">
                     <div>
                        <svg viewBox="0 0 53 53" width="53" height="53" className="">
                           ...
                           <g clipPath="url(#document-SVGID_2_)">
                              <path fill="#5157AE"
                                    d="M26.5-1.1C11.9-1.1-1.1 5.6-1.1 27.6h55.2c-.1-19-13-28.7-27.6-28.7z"></path>
                              <path fill="#5F66CD" d="M53 26.5H-1.1c0 14.6 13 27.6 27.6 27.6s27.6-13 27.6-27.6H53z"></path>
                           </g>
                           <g fill="#F5F5F5">
