export default function Default(){
    return (
        <div className="flex h-full flex-col justify-center items-center">
            <div>
                <svg width="360" viewBox="0 0 303 172" fill="none" preserveAspectRatio="xMidYMid meet" className="">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="#F1F1F2" fillOpacity=".38"></path>
            ...
            <h2 className="mt-10 text-3xl text-[rgba(233,237,239,0.88)]">WhatsApp Web</h2>
            <p className="mt-5 text-sm text-center text-[#8696a0]">
                Send and receive messages without keeping your phone online.
                <br/>
                Use WhatsApp on up to 4 linked devices and 1 phone at the same time.
            </p>
            <div className="flex items-center mt-7 text-[#667781] text-sm">
